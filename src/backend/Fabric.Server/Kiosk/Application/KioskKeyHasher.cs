...
public sealed class KioskKeyHasher
{
    private const int SaltSize = 32;
    private const int KeySize = 32;
    private const int Iterations = 100_000;

    public KioskKey CreateKey()
    {
        ...
        return new KioskKey(key, hash, salt);
    }
...
public sealed record KioskKey(string Key, string Hash, string Salt);
