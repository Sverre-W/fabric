...
[Activity("Fabric", "Kiosk", "Mark current kiosk session as failed.", DisplayName = "Fail Kiosk Session")]
public sealed class FailKioskSession : CodeActivity
{
    protected override async ValueTask ExecuteAsync(ActivityExecutionContext context)
    {
        ...
        session.Fail(timeProvider.GetUtcNow());
