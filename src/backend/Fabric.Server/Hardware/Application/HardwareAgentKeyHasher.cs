...
public sealed class HardwareAgentKeyHasher
{
    private const int SaltSize = 32;
    private const int KeySize = 32;
    private const int Iterations = 100_000;

    public HardwareAgentKey CreateKey()
    {
        ...
        return new HardwareAgentKey(key, hash, salt);
    }
...
public sealed record HardwareAgentKey(string Key, string Hash, string Salt);
