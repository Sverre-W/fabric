    ...
    <AutomationPageShell title="Workflow Definition Editor" description="Edit workflow structure, activities, inputs, outputs, and persistence settings in Elsa Studio.">
      {(props) => (
        <div className="grid gap-3">
          <Link to="/automation/workflow-definitions" className="w-fit rounded-interactive border border-border px-3 py-2 text-[14px] font-semibold transition hover:bg-hover-blue">
