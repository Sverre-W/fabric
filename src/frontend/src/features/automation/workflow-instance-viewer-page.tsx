    ...
    <AutomationPageShell title="Workflow Instance Viewer" description="View workflow instance state, execution log, variables, and completed activities.">
      {(props) => (
        <div className="grid gap-3">
          <Link to="/automation/workflow-instances" className="w-fit rounded-interactive border border-border px-3 py-2 text-[14px] font-semibold transition hover:bg-hover-blue">
